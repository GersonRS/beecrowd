            ...
            for c in frase[i]:
                for j in range(C):
                    if c == criptografia[0][j]:
                        msg += (
                            criptografia[1][j].lower()
                            if decifrando(c)
                            else criptografia[1][j]
                        )
                        break
                    elif c == criptografia[1][j]:
                        msg += (
                            criptografia[0][j].lower()
                            if decifrando(c)
                            else criptografia[0][j]
                        )
                        break
                    elif c == criptografia[2][j]:
                        msg += (
                            criptografia[3][j].lower()
                            if decifrando(c)
                            else criptografia[3][j]
                        )
                        break
                    elif c == criptografia[3][j]:
                        msg += (
                            criptografia[2][j].lower()
                            if decifrando(c)
                            else criptografia[2][j]
                        )
                        break
                    elif j + 1 == C:
                        msg += c
